...
import { z } from "zod";
 ...
 export const specialityLevelSchema = z.object({ "Buffs": z.array(z.lazy(() => buffSchema)).max(10), "level": z.lazy(() => specialityLevelNamesSchema) }) as z.ZodType<SpecialityLevel>;
