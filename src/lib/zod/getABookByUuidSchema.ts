...
export type GetABookByUuidPathParamsSchema = z.infer<
  typeof getABookByUuidPathParamsSchema
>;

/**
 * @description OK - Successful request with response body
 */
export const getABookByUuid200Schema = z.union([
  z.lazy(() => builtinBookSchema),
  z.lazy(() => standardBookSchema),
]) as z.ZodType<GetABookByUuid200>;
 ...
 */
export const getABookByUuid400Schema = z.object({
  errors: z
    .array(z.object({ message: z.string().max(1000) }))
    .max(10)
    .optional(),
  message: z.string().max(1000),
}) as z.ZodType<GetABookByUuid400>;
 ...
 */
export const getABookByUuid404Schema = z.object({
  message: z.string().max(1000),
}) as z.ZodType<GetABookByUuid404>;
 ...
 */
export const getABookByUuid500Schema = z.object({
  message: z.string().max(1000),
}) as z.ZodType<GetABookByUuid500>;

export type GetABookByUuid500Schema = z.infer<typeof getABookByUuid500Schema>;

export const getABookByUuidQueryResponseSchema = z.union([
  z.lazy(() => getABookByUuid200Schema),
  z.lazy(() => getABookByUuid204Schema),
]) as z.ZodType<GetABookByUuidQueryResponse>;

export type GetABookByUuidQueryResponseSchema = z.infer<
  typeof getABookByUuidQueryResponseSchema
>;
