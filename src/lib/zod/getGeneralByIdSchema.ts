...
export type GetGeneralByIdPathParamsSchema = z.infer<
  typeof getGeneralByIdPathParamsSchema
>;

export const getGeneralByIdQueryParamsSchema = z
  .object({
    ...
    level: z
      ...
      .optional(),
    AscendingLevel: z.lazy(() => ascendingLevelNamesSchema).optional(),
    SpecialityLevel: z
  ...
  .optional() as z.ZodType<GetGeneralByIdQueryParams>;

export type GetGeneralByIdQueryParamsSchema = z.infer<
  typeof getGeneralByIdQueryParamsSchema
>;
 ...
 */
export const getGeneralById400Schema = z.object({
  errors: z
    .array(z.object({ message: z.string().max(1000) }))
    .max(10)
    .optional(),
  message: z.string().max(1000),
}) as z.ZodType<GetGeneralById400>;
 ...
 */
export const getGeneralById404Schema = z.object({
  message: z.string().max(1000),
}) as z.ZodType<GetGeneralById404>;
 ...
 */
export const getGeneralById500Schema = z.object({
  message: z.string().max(1000),
}) as z.ZodType<GetGeneralById500>;
...
export type GetGeneralByIdQueryResponseSchema = z.infer<
  typeof getGeneralByIdQueryResponseSchema
>;
