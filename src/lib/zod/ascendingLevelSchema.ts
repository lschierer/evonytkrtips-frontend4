 ...
 */
export const ascendingLevelSchema = z.object({ "buffs": z.array(z.lazy(() => buffSchema)).max(10), "level": z.lazy(() => ascendingLevelNamesSchema) }).describe("The effect of one star of ascending") as z.ZodType<AscendingLevel>;
