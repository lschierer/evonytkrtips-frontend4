...
import { z } from "zod";
 ...
 export const generalListSchema = z.object({ "type": z.lazy(() => generalEvaluationTypesSchema), "members": z.array(z.lazy(() => generalListItemSchema)).max(1000) }) as z.ZodType<GeneralList>;
