 ...
 */
export const ascendingLevelNamesSchema = z.union([z.literal("none"), z.lazy(() => redGeneralAscendingLevelsSchema), z.lazy(() => purpleGeneralAscendingLevelsSchema)]).default("none").describe("A general Ascends as either a Red or a Purple General but not both.\n") as z.ZodType<AscendingLevelNames>;
