 ...
 */
export const basicAttributesSummarySchema = z.object({ "attack": z.lazy(() => basicAttributesObjectSummarySchema), "defense": z.lazy(() => basicAttributesObjectSummarySchema), "politics": z.lazy(() => basicAttributesObjectSummarySchema), "leadership": z.lazy(() => basicAttributesObjectSummarySchema) }).describe("A summary of the values that the basic attributes have at a particular level, after they have been computed for that level. ") as z.ZodType<BasicAttributesSummary>;
