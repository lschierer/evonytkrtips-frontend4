...
export type { DebuffConditionsEnum, DebuffConditions } from "./DebuffConditions.js";
export type { General } from "./General.js";
export type { GeneralEvaluationTypesEnum, GeneralEvaluationTypes } from "./GeneralEvaluationTypes.js";
export type { GeneralList } from "./GeneralList.js";
export type { GeneralListItem } from "./GeneralListItem.js";
export type { GeneralsHtmlListPathParams, GeneralsHtmlList200, GeneralsHtmlList204, GeneralsHtmlList400, GeneralsHtmlList500, GeneralsHtmlListQueryResponse, GeneralsHtmlListQuery } from "./GeneralsHtmlList.js";
export type { GeneralSummary } from "./GeneralSummary.js";
export type { GetABookByUuidPathParams, GetABookByUuid200, GetABookByUuid204, GetABookByUuid400, GetABookByUuid404, GetABookByUuid500, GetABookByUuidQueryResponse, GetABookByUuidQuery } from "./GetABookByUuid.js";
export type { GetAllBooksPathParams, GetAllBooks200, GetAllBooks204, GetAllBooks400, GetAllBooks500, GetAllBooksQueryResponse, GetAllBooksQuery } from "./GetAllBooks.js";
export type { GetGeneralByIdPathParams, GetGeneralByIdQueryParams, GetGeneralById200, GetGeneralById400, GetGeneralById404, GetGeneralById500, GetGeneralByIdQueryResponse, GetGeneralByIdQuery } from "./GetGeneralById.js";
...
export type { PurpleGeneralAscendingLevelsEnum, PurpleGeneralAscendingLevels } from "./PurpleGeneralAscendingLevels.js";
export type { RedGeneralAscendingLevelsEnum, RedGeneralAscendingLevels } from "./RedGeneralAscendingLevels.js";
...
export type { SpecialityLevelNamesEnum, SpecialityLevelNames } from "./SpecialityLevelNames.js";
...
export type { UuidForTypeAndNamePathParams, UuidForTypeAndName200, UuidForTypeAndName204, UuidForTypeAndName400, UuidForTypeAndName500, UuidForTypeAndNameQueryResponse, UuidForTypeAndNameQuery } from "./UuidForTypeAndName.js";
