export const buffConditionEnum = {
 ...
 export type BuffConditionEnum = (typeof buffConditionEnum)[keyof typeof buffConditionEnum];

 /**
 * @description Some Buffs apply only conditionally
*/
export type BuffCondition = BuffConditionEnum;